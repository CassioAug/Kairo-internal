    ...
    when (this) {
        RsvpProfile.BALANCED ->
            RsvpConfig().copy(
                ...
                punctuationPauseFactor = 1.02,
                useFocalStress = true,
                focalSupportCompression = 0.94,
                useAnticipatoryLanding = true,
                anticipatoryLandingBoost = 1.08,
        ...
        RsvpProfile.CHILL ->
            RsvpConfig().copy(
                ...
                commaPauseMs = 168L,
                periodPauseMs = 405L,
                semicolonPauseMs = 278L,
                colonPauseMs = 254L,
                dashPauseMs = 268L,
                parenthesesPauseMs = 170L,
                quotePauseMs = 112L,
                sentenceEndPauseMs = 432L,
                paragraphPauseMs = 540L,
                paragraphPauseMultiplier = 1.48,
                pageBreakPauseMultiplier = 3.85,
        ...
        RsvpProfile.NARRATIVE ->
            RsvpConfig().copy(
                ...
                useParentheticalAside = true,
                parentheticalAsideMultiplier = 0.86,
                blinkMode = BlinkMode.OFF,
            )
        RsvpProfile.FOCUS ->
            RsvpConfig().copy(
                ...
                commaPauseMs = 104L,
                periodPauseMs = 238L,
                semicolonPauseMs = 172L,
                colonPauseMs = 160L,
                dashPauseMs = 166L,
                parenthesesPauseMs = 108L,
                quotePauseMs = 58L,
                sentenceEndPauseMs = 252L,
                paragraphPauseMs = 292L,
                paragraphPauseMultiplier = 1.24,
                pageBreakPauseMultiplier = 3.05,
                pauseScaleExponent = 0.48,
                minPauseScale = 0.75,
                usePunctuationLandingHold = true,
                parentheticalMultiplier = 1.08,
                dialogueMultiplier = 0.98,
                dialoguePunctuationScale = 0.88,
                smoothingAlpha = 0.32,
                ...
                punctuationPauseFactor = 0.96,
                useFocalStress = true,
                focalSupportCompression = 0.90,
                useAnticipatoryLanding = true,
                anticipatoryLandingBoost = 1.05,
                useParentheticalAside = true,
                parentheticalAsideMultiplier = 0.84,
        ...
        RsvpProfile.FLOW ->
            RsvpConfig().copy(
                ...
                colonPauseMs = 176L,
                dashPauseMs = 184L,
                parenthesesPauseMs = 116L,
                quotePauseMs = 68L,
                sentenceEndPauseMs = 270L,
                paragraphPauseMs = 318L,
                paragraphPauseMultiplier = 1.28,
                pageBreakPauseMultiplier = 3.15,
                pauseScaleExponent = 0.50,
                minPauseScale = 0.76,
                usePunctuationLandingHold = true,
                parentheticalMultiplier = 1.10,
                dialogueMultiplier = 0.95,
                dialoguePunctuationScale = 0.86,
                smoothingAlpha = 0.28,
                maxSpeedupFactor = 1.20,
        ...
        RsvpProfile.SPRINT ->
            RsvpConfig().copy(
                ...
                commaPauseMs = 92L,
                periodPauseMs = 216L,
                semicolonPauseMs = 158L,
                colonPauseMs = 150L,
                dashPauseMs = 156L,
                parenthesesPauseMs = 96L,
                quotePauseMs = 48L,
                sentenceEndPauseMs = 230L,
                paragraphPauseMs = 264L,
                paragraphPauseMultiplier = 1.16,
                pageBreakPauseMultiplier = 2.85,
                pauseScaleExponent = 0.44,
                minPauseScale = 0.78,
                usePunctuationLandingHold = true,
                parentheticalMultiplier = 1.06,
                dialogueMultiplier = 0.99,
                dialoguePunctuationScale = 0.80,
                smoothingAlpha = 0.24,
                ...
                punctuationPauseFactor = 0.92,
                useFocalStress = true,
                focalSupportCompression = 0.88,
                useAnticipatoryLanding = true,
                anticipatoryLandingBoost = 1.04,
                useParentheticalAside = true,
                parentheticalAsideMultiplier = 0.82,
                blinkMode = BlinkMode.ADAPTIVE,
            )
        RsvpProfile.STUDY ->
            RsvpConfig().copy(
                ...
                commaPauseMs = 162L,
                periodPauseMs = 414L,
                semicolonPauseMs = 276L,
                colonPauseMs = 258L,
                dashPauseMs = 266L,
                parenthesesPauseMs = 178L,
                quotePauseMs = 116L,
                sentenceEndPauseMs = 442L,
                paragraphPauseMs = 560L,
                paragraphPauseMultiplier = 1.56,
                pageBreakPauseMultiplier = 4.0,
